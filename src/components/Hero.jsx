          ...
          >
            ...
            >
              <motion.button
                ...
                className="group bg-gradient-gold text-black px-8 py-4 rounded-full font-bold text-lg shadow-2xl hover:shadow-accent-gold/50 transition-all duration-300 flex items-center justify-center space-x-2"
              >
                <BookOpen size={24} />
